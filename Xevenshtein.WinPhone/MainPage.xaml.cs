...
namespace Xevenshtein.WinPhone
{
    ...
    public sealed partial class MainPage : Page
    {
        public MainPage()
        {
            ...
            this.ComputeButton.Click += (s, a) =>
            {
                var resultado = Xevenshtein.Core.Levenshtein.Compute(FirsWordTextInput.Text, SecondWordTextInput.Text);
                ResultTextVeiw.Text = resultado.ToString();
            };
        }
